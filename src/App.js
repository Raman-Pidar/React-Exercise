...
const ToastButtons = () => {
  ...
  return (
    <div className="App">
      ...
      <button
        onClick={() => {
          // setToastName(toast.normal);
          setToggle({ toggle: true, name: "normal", text: "normal toast" });
        }}
      >
        Normal Toast
      </button>
      ...
      <button
        onClick={() => {
          // setToastName(toast.warning);
          setToggle({ toggle: true, name: "warning", text: "WARNING!" });
        }}
      >
        Warning Toast
      </button>
...
const PrintList = () => {
  const list = ["nike airmags", "nike airforce1", "adidas yeezy"];
...
export default function App() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: `${mode}`, color: `${fontColor}` }}
    >
      <h1>COMBINED REACT EXERCISES</h1>
